...
export const FlagEstoniaIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <path fill='#fff' d='M2 16h20a2 2 0 0 0 2-2v-3H0v3a2 2 0 0 0 2 2Z' />
    <path fill='#333' d='M24 5H0v6h24V5Z' />
    <path fill='#5DA8F1' d='M2 0h20a2 2 0 0 1 2 2v3H0V2a2 2 0 0 1 2-2Z' />
    <path
      fill='#000'
      fillOpacity={0.08}
      fillRule='evenodd'
