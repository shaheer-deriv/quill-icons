...
export const FlagArmeniaIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <path fill='#F4A900' d='M0 11h24v3a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-3Z' />
    <path fill='#002EA3' d='M24 5H0v6h24V5Z' />
    <path fill='#DC0000' d='M2 0h20a2 2 0 0 1 2 2v3H0V2a2 2 0 0 1 2-2Z' />
    <path
      fill='#000'
      fillOpacity={0.08}
      fillRule='evenodd'
