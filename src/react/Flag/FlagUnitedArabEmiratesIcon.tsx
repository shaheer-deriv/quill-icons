...
export const FlagUnitedArabEmiratesIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <path fill='#333' d='M6 11h18v3a2 2 0 0 1-2 2H6v-5Z' />
    <path fill='#fff' d='M6 5h18v6H6V5Z' />
    <path fill='#12833B' d='M6 0h16a2 2 0 0 1 2 2v3H6V0Z' />
    <path fill='#FF323E' d='M2 0h4v16H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2Z' />
    <path
      fill='#000'
      fillOpacity={0.08}
      fillRule='evenodd'
