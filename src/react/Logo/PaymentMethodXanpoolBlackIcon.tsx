...
const PaymentMethodXanpoolBlackIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <g fill='#000'>
      ...
      <path
        fillRule='evenodd'
        d='M67.468 47.286v-5.503l2.907-.106c2.306 0 4.11-1.904 4.11-4.338S72.682 33 70.376 33h-5.413v14.286zm1.303-7.831h-1.303v-4.127h1.203c.802 0 1.404 0 1.704.106.401.106.702.317 1.003.635.3.317.401.74.401 1.27 0 .423-.1.846-.3 1.164-.201.317-.502.635-.803.74-.3.106-.902.212-1.905.212M85.276 47.286a7.12 7.12 0 0 0 7.143-7.143A7.121 7.121 0 0 0 85.276 33a7.121 7.121 0 0 0-7.143 7.143 7.12 7.12 0 0 0 7.143 7.143M80.8 40.143c0-2.45 2.025-4.49 4.477-4.49 2.452 0 4.478 2.04 4.478 4.49 0 2.449-2.026 4.49-4.478 4.49s-4.477-2.041-4.477-4.49M110.352 40.143a7.12 7.12 0 0 1-7.142 7.143 7.12 7.12 0 0 1-7.143-7.143A7.121 7.121 0 0 1 103.21 33a7.12 7.12 0 0 1 7.142 7.143m-7.142-4.49c-2.453 0-4.478 2.04-4.478 4.49 0 2.449 2.025 4.49 4.478 4.49 2.452 0 4.477-2.041 4.477-4.49 0-2.45-2.025-4.49-4.477-4.49'
        clipRule='evenodd'
      />
    </g>
  </svg>
