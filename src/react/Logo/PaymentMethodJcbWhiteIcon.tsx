...
const PaymentMethodJcbWhiteIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <g fill='#fff'>
      ...
      <path d='M80.765 45.962h4.619c.066 0 .176-.01.286-.022h.002c.11-.011.218-.022.284-.022.88-.176 1.627-.968 1.627-2.067 0-1.056-.748-1.848-1.627-2.068-.132-.044-.396-.044-.572-.044h-4.619zM87.011 37.429c0-1.056-.748-1.76-1.627-1.892-.04 0-.106-.008-.179-.018a2.215 2.215 0 0 0-.261-.026h-4.179v3.871h4.179c.132 0 .396 0 .44-.044.88-.132 1.627-.836 1.627-1.891' />
    </g>
  </svg>
);
