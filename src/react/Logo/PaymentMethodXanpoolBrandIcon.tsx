...
const PaymentMethodXanpoolBrandIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <g fill='#5B69F2'>
      ...
      <path
        fillRule='evenodd'
        d='M67.468 41.783v5.503h-2.506V33h5.413c2.306 0 4.11 1.905 4.11 4.339s-1.804 4.338-4.11 4.338zm0-2.328h1.303c1.003 0 1.605-.106 1.905-.212.301-.105.602-.423.802-.74.2-.318.301-.741.301-1.164 0-.53-.1-.953-.401-1.27-.3-.318-.602-.53-1.003-.635-.3-.106-.902-.106-1.704-.106h-1.203zM92.419 40.143a7.121 7.121 0 0 1-7.143 7.143 7.121 7.121 0 0 1-7.143-7.143A7.121 7.121 0 0 1 85.276 33a7.121 7.121 0 0 1 7.143 7.143m-7.143-4.49c-2.452 0-4.477 2.04-4.477 4.49 0 2.449 2.025 4.49 4.477 4.49 2.452 0 4.478-2.041 4.478-4.49 0-2.45-2.026-4.49-4.478-4.49M103.21 47.286a7.12 7.12 0 0 0 7.142-7.143A7.12 7.12 0 0 0 103.21 33a7.121 7.121 0 0 0-7.143 7.143 7.121 7.121 0 0 0 7.143 7.143m-4.478-7.143c0-2.45 2.025-4.49 4.478-4.49 2.452 0 4.477 2.04 4.477 4.49 0 2.449-2.025 4.49-4.477 4.49-2.453 0-4.478-2.041-4.478-4.49'
        clipRule='evenodd'
      />
    </g>
  </svg>
