...
const PaymentMethodDiscoverBrandIcon = (
  ...
  >
    ...
    />
    <path
      fill='url(#46c8bf56d76cf814969c1a34a95c0981__b)'
      d='M66.653 49.928c5.483 0 9.928-4.445 9.928-9.928 0-5.483-4.445-9.928-9.928-9.928-5.483 0-9.927 4.445-9.927 9.928 0 5.483 4.444 9.928 9.927 9.928'
    />
    <path
      fill='#231F20'
      d='M122.106 31.295c0-.328-.209-.507-.597-.507h-.536v1.64h.387V31.8l.448.626h.477l-.537-.685c.239-.06.358-.209.358-.448m-.686.208h-.06v-.417h.06c.209 0 .298.06.298.209s-.089.208-.298.208'
    />
    <path
      fill='#231F20'
      d='M121.569 30.192a1.433 1.433 0 0 0-1.431 1.4 1.431 1.431 0 1 0 1.431-1.43zm0 2.593a1.166 1.166 0 0 1-1.056-.745 1.158 1.158 0 0 1-.077-.447c0-.626.507-1.163 1.133-1.163.596 0 1.133.537 1.133 1.192 0 .627-.507 1.163-1.133 1.163'
    />
    <defs>
      <linearGradient
        id='46c8bf56d76cf814969c1a34a95c0981__a'
        x1={94.297}
        x2={92.683}
        y1={47.93}
        y2={32.935}
      ...
      <linearGradient
        id='46c8bf56d76cf814969c1a34a95c0981__b'
        x1={87.742}
        x2={85.624}
        y1={47.781}
        y2={23.201}
