...
export const IllustrativeCriticalIcon = (
  ...
  >
    <g>
      ...
      <path d='m20.867 14.64-4.574-2.287a.663.663 0 0 0-.593 0l-4.573 2.287a.674.674 0 0 0-.3.893.671.671 0 0 0 .9.294L16 13.687l4.273 2.14a.662.662 0 0 0 .894-.3.662.662 0 0 0-.3-.894v.007ZM20.867 18.453l-4.574-2.286a.664.664 0 0 0-.593 0l-4.573 2.286a.674.674 0 0 0-.3.894c.166.326.566.46.893.3l4.273-2.14 4.274 2.14a.671.671 0 0 0 .9-.293.662.662 0 0 0-.3-.894v-.007Z' />
    </g>
  </svg>
);
