...
export const MarketStocksNovartisIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#7cf9611645717db7f318fd1b305584d4__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#7cf9611645717db7f318fd1b305584d4__b)'
    ...
    <defs>
      <linearGradient
        id='7cf9611645717db7f318fd1b305584d4__b'
        x1={-0.007}
        x2={31.992}
        y1={15.996}
        y2={15.996}
      ...
      <clipPath id='7cf9611645717db7f318fd1b305584d4__a'>
