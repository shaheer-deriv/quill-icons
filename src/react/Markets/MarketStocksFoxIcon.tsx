...
export const MarketStocksFoxIcon = (
  ...
  >
    <g clipPath='url(#a)'>
      ...
      <path
        fill='#fff'
        d='M6.915 13.657V15h2.84v2.809h-2.84v3.327H4V10.833h6.197l.199 2.824h-3.48Z'
      />
      <path
        fill='#fff'
        fillRule='evenodd'
        d='M18.719 12.417c.967.987 1.45 2.179 1.45 3.575 0 1.406-.483 2.603-1.45 3.59-.968.987-2.134 1.48-3.5 1.48-1.377 0-2.549-.493-3.516-1.48-.967-.987-1.45-2.184-1.45-3.59 0-1.396.483-2.588 1.45-3.575.967-.987 2.14-1.481 3.516-1.481 1.366 0 2.532.494 3.5 1.48Zm-4.338 5.639c0 .23.084.429.254.598.17.17.374.255.613.255a.81.81 0 0 0 .606-.255.83.83 0 0 0 .247-.598v-4.173a.849.849 0 0 0-.247-.614.812.812 0 0 0-.606-.254.836.836 0 0 0-.613.254.835.835 0 0 0-.254.614v4.173Z'
        clipRule='evenodd'
      />
      <path
        fill='#fff'
