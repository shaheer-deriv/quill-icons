...
export const MarketStocksBiogenIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#e8eccd069fa537fe05cd24b1819b33b0__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#e8eccd069fa537fe05cd24b1819b33b0__b)'
        d='M11.55 22.083c3.082-.984 7.551-2.873 8.36-5.031.718-1.915-2.05-6.004-4.605-9.114a8.466 8.466 0 0 0-3.754 14.145'
      />
      <path
        fill='url(#e8eccd069fa537fe05cd24b1819b33b0__c)'
      ...
      />
      <path
        fill='url(#e8eccd069fa537fe05cd24b1819b33b0__d)'
      ...
      />
      <path
        fill='url(#e8eccd069fa537fe05cd24b1819b33b0__e)'
      ...
      />
      <path
        fill='url(#e8eccd069fa537fe05cd24b1819b33b0__f)'
    ...
    <defs>
      <linearGradient
        id='e8eccd069fa537fe05cd24b1819b33b0__c'
        x1={7.499}
        x2={36.136}
        y1={34.785}
        y2={21.7}
      ...
      <linearGradient
        id='e8eccd069fa537fe05cd24b1819b33b0__d'
        x1={30.026}
        x2={15.805}
        y1={1.061}
        y2={31.681}
      ...
      <linearGradient
        id='e8eccd069fa537fe05cd24b1819b33b0__e'
        x1={26.483}
        x2={-3.242}
        y1={26.401}
        y2={6.258}
      ...
      <radialGradient
        id='e8eccd069fa537fe05cd24b1819b33b0__b'
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id='e8eccd069fa537fe05cd24b1819b33b0__f'
        cx={0}
        cy={0}
        r={1}
      ...
      <clipPath id='e8eccd069fa537fe05cd24b1819b33b0__a'>
