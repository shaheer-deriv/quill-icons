...
export const MarketDerivedJump10Icon = (
  ...
  >
    ...
    <path
      fill='#414652'
      d='M10.064 6.728c-.123.235-.344.352-.664.352-.32 0-.541-.117-.664-.352s-.184-.565-.184-.992V4.68c0-.427.061-.757.184-.992s.344-.352.664-.352c.32 0 .541.117.664.352s.184.565.184.992v1.056c0 .427-.061.757-.184.992Z'
    />
    <path
      fill='#414652'
      fillRule='evenodd'
      d='M2 0a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2Zm5.776 7.336c.352.507.893.76 1.624.76.73 0 1.272-.253 1.624-.76.352-.507.528-1.216.528-2.128 0-.912-.176-1.621-.528-2.128-.352-.507-.893-.76-1.624-.76-.73 0-1.272.253-1.624.76-.352.507-.528 1.216-.528 2.128 0 .912.176 1.621.528 2.128Zm-4.82-.304V8h3.887v-.968H5.66V2.416H3.82l-1.336 1.76.768.6 1.136-1.488h.072v3.744H2.955Z'
      clipRule='evenodd'
    />
    <path
      fill='#fff'
      d='M2.955 8v-.968H4.46V3.288h-.072L3.251 4.776l-.768-.6 1.336-1.76h1.84v4.616h1.184V8H2.955ZM9.4 8.096c-.73 0-1.272-.253-1.624-.76-.352-.507-.528-1.216-.528-2.128 0-.912.176-1.621.528-2.128.352-.507.893-.76 1.624-.76.73 0 1.272.253 1.624.76.352.507.528 1.216.528 2.128 0 .912-.176 1.621-.528 2.128-.352.507-.893.76-1.624.76Zm0-1.016c.32 0 .541-.117.664-.352s.184-.565.184-.992V4.68c0-.427-.061-.757-.184-.992s-.344-.352-.664-.352c-.32 0-.541.117-.664.352s-.184.565-.184.992v1.056c0 .427.061.757.184.992s.344.352.664.352Z'
    />
  </svg>
);
