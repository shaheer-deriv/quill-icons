...
export const MarketDerivedVolatility75Icon = (
  ...
  >
    <path
      fill='#0AA0B0'
      d='M22.5 13H24v9h-1.5v10h-1V22H20v-9h1.5v-2h1v2ZM30 11v7h-1.5v4h-1v-4H26v-7h4ZM16.5 20v-4h-1v4H14v8h1.5v2h1v-2H18v-8h-1.5ZM10.5 15H12v6h-1.5v7h-1v-7H8v-6h1.5v-2h1v2ZM4.5 19H6v4H4.5v2h-1v-2H2v-4h1.5v-2h1v2Z'
    />
    <path
      fill='#414652'
      fillRule='evenodd'
    ...
    <path
      fill='#fff'
      d='m3.531 8 1.872-4.608H3.66v1.016H2.643V2.416h3.952v1.04L4.795 8H3.531ZM11.176 3.464H8.64l-.12 1.768h.064c.053-.133.112-.253.176-.36.07-.112.15-.205.24-.28.09-.08.2-.141.328-.184.128-.043.28-.064.456-.064.24 0 .464.04.672.12a1.6 1.6 0 0 1 .912.912c.09.219.136.467.136.744 0 .283-.048.547-.144.792-.09.24-.23.448-.416.624a1.939 1.939 0 0 1-.672.416c-.267.096-.57.144-.912.144-.272 0-.512-.03-.72-.088a2.261 2.261 0 0 1-.552-.232 2.043 2.043 0 0 1-.416-.344 2.457 2.457 0 0 1-.304-.408l.872-.688c.123.219.27.405.44.56.17.15.4.224.688.224.288 0 .504-.083.648-.248.15-.165.224-.384.224-.656v-.064c0-.256-.075-.459-.224-.608-.15-.15-.355-.224-.616-.224-.219 0-.4.045-.544.136-.139.085-.245.17-.32.256l-.984-.136.208-3.16h3.416v1.048Z'
    />
  </svg>
);
